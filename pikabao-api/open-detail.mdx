---
title: "开卡详情"
api: "POST /bank_card/open_detail"
...
<RequestExample>
```bash cURL
curl --location --request POST 'http://kf.pikabao.cc/bank_card/open_detail' \
...
const response = await fetch("http://kf.pikabao.cc/bank_card/open_detail", {
  method: "POST",
  headers: {
