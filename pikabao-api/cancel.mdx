---
title: "信用卡销卡"
api: "DELETE /agent/v1/cards/destroy"
...
<RequestExample>
```bash cURL
curl --location --request DELETE 'http://kf.pikabao.cc/agent/v1/cards/destroy?appid=user123&cardId=111222333&timestamp=1640995200000&sign=ABC123...'
```
...
const response = await fetch(
  `http://kf.pikabao.cc/agent/v1/cards/destroy?${new URLSearchParams({...params, sign})}`,
  { method: "DELETE" }
);
