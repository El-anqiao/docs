---
title: "信用卡资金转出"
api: "POST /bank_card/card_cash_out"
...
<RequestExample>
```bash cURL
curl --location --request POST 'http://kf.pikabao.cc/bank_card/card_cash_out' \
...
const response = await fetch("http://kf.pikabao.cc/bank_card/card_cash_out", {
  method: "POST",
  headers: {
