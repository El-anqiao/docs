---
title: "信用卡冻结"
api: "PUT /agent/v1/cards/suspend"
...
<RequestExample>
```bash cURL
curl --location --request PUT 'http://kf.pikabao.cc/agent/v1/cards/suspend?appid=user123&cardId=111222333&timestamp=1640995200000&sign=ABC123...'
```
...
const response = await fetch(
  `http://kf.pikabao.cc/agent/v1/cards/suspend?${new URLSearchParams({...params, sign})}`,
  { method: "PUT" }
);
