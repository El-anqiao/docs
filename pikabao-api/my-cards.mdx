...
<RequestExample>
```bash cURL
curl --location 'http://kf.pikabao.cc/agent/v1/cards/list?appid=user123&timestamp=1640995200000&sign=ABC123...'
```
...
const response = await fetch(
  `http://kf.pikabao.cc/agent/v1/cards/list?${new URLSearchParams({...params, sign})}`
);
