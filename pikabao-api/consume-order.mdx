---
title: "交易订单查询"
api: "GET /bank_card/consume_order"
...
<RequestExample>
```bash cURL
curl --location 'http://kf.pikabao.cc/bank_card/consume_order?appid=user123&page=1&pageSize=20&timestamp=1640995200000&sign=ABC123...'
```
...
const response = await fetch(
  `http://kf.pikabao.cc/bank_card/consume_order?${new URLSearchParams({...params, sign})}`
);
...
response = requests.get(
    "http://kf.pikabao.cc/bank_card/consume_order",
    params=params
)
