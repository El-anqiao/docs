...
<RequestExample>
```bash cURL
curl --location 'http://kf.pikabao.cc/agent/v1/cards/bins?appid=user123&timestamp=1640995200000&sign=ABC123...'
```
...
const response = await fetch(
  `http://kf.pikabao.cc/agent/v1/cards/bins?${new URLSearchParams({...params, sign})}`
);
