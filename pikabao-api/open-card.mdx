...
<RequestExample>
```bash cURL
curl --location --request POST 'http://kf.pikabao.cc/agent/v1/cards/open' \
...
const response = await fetch("http://kf.pikabao.cc/agent/v1/cards/open", {
  method: "POST",
  headers: {
...
response = requests.post(
    "http://kf.pikabao.cc/agent/v1/cards/open",
    json=data
)
