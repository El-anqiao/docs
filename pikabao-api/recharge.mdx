...
<RequestExample>
```bash cURL
curl --location --request POST 'http://kf.pikabao.cc/bank_card/recharge' \
...
const response = await fetch("http://kf.pikabao.cc/bank_card/recharge", {
  method: "POST",
  headers: {
